...
public class HunterButton extends HeroButton implements ActionListener {
	public HunterButton() {
		setName("Hunter");
		ImageIcon hunter = new ImageIcon("Icons/Hunter.png");
		setIcon(hunter);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (getActionCommand().equals("this")) {
			setIcon(new ImageIcon("Icons/Hun Sel.png"));
			setActionCommand("Selected");
		} else {
			if (getActionCommand().equals("Selected")) {
				setIcon(new ImageIcon("Icons/Hunter.png"));
