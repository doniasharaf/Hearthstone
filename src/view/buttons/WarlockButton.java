...
public class WarlockButton extends HeroButton implements ActionListener {
	public WarlockButton() {
		setName("Warlock");
		ImageIcon warlock = new ImageIcon("Icons/Warlock.png");
		setIcon(warlock);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (getActionCommand().equals("this")) {
			setIcon(new ImageIcon("Icons/War Sel.png"));
			setActionCommand("Selected");
		} else {
			if (getActionCommand().equals("Selected")) {
				setIcon(new ImageIcon("Icons/Warlock.png"));
