...
public class PaladinButton extends HeroButton implements ActionListener {
	public PaladinButton() {
		setName("Paladin");
		ImageIcon paladin = new ImageIcon("Icons/Paladin.png");
		setIcon(paladin);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (getActionCommand().equals("this")) {
			setIcon(new ImageIcon("Icons/Pal sel.png"));
			setActionCommand("Selected");
		} else {
			if (getActionCommand().equals("Selected")) {
				setIcon(new ImageIcon("Icons/Paladin.png"));
