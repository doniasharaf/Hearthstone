...
public class FieldPanelOne extends JLabel {
	Controller c;

	public FieldPanelOne(Controller c, ArrayList<Minion> field,
			boolean isAttacker) {
		super();
		...
		this.setBounds(
				0,
				(int) (Toolkit.getDefaultToolkit().getScreenSize().height * 0.15),
